...
- (int) match:(NSArray *)otherCards {
  ...
  if ([self isFeatureAllowSetFeature1:[NSNumber numberWithUnsignedInteger:self.shapeIndex]
                            ...
                            feature3:[NSNumber numberWithUnsignedInteger:card2.shapeIndex]]) {
    score++;
  } else {
    return 0;
  }
  ...
  if ([self isFeatureAllowSetFeature1:[NSNumber numberWithUnsignedInteger:self.numOfSymbol]
                            ...
                            feature3:[NSNumber numberWithUnsignedInteger:card2.numOfSymbol]]) {
    score++;
  } else {
    return 0;
  }
  ...
  if ([self isFeatureAllowSetFeature1:[NSNumber numberWithUnsignedInteger:self.color]
                            ...
                            feature3:[NSNumber numberWithUnsignedInteger:card2.color]]) {
    score++;
  } else {
    return 0;
  }
  ...
  if ([self isFeatureAllowSetFeature1:[NSNumber numberWithUnsignedInteger:self.shading]
                            ...
                            feature3:[NSNumber numberWithUnsignedInteger:card2.shading]]) {
    score++;
  } else {
    return 0;
  }
...
- (BOOL) isFeatureAllowSetFeature1:(NSNumber *)feature1 feature2:(NSNumber *)feature2 feature3:(NSNumber *)feature3 {
